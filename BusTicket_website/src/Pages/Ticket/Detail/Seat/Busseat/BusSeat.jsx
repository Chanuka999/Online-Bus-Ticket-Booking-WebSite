        ...
        <div className="col-span-2 w-full space-y-5 bg-neutral-50 rounded-xl py-4 px-6 border border-neutral-200 shadow-sm">
          ...
          <div className="w-full space-y-2">
            <div className="w-full flex items-center justify-between">
              ...
              <div className="bg-primary/20 rounded-lg py-0.5 px-1.5 text-xs text-xs text-neutral-600 font-normal uppercase">
                Non-refundable
              </div>
            </div>
          ...
          <div className="w-full space-y-2">
            ...
            <div className="w-full flex items-center ustify-between border-dashed border-1-[1.5px] border-neutral-400 pl-2">
              <h3 className="text-sm text-neutral-500 font-medium">
                Basic Fair:
              </h3>
              <p className="text-sm text-neutral-600 font-medium">LKR.1600</p>
            </div>
          ...
          <div className="w-full flex items-center justify-center">
            {selectedSeats.length > 0 ? (
              <Link
                ...
                className="w-full bg-red-500 hover:bg-primary/90 text-sm text-neutral-50 font-normal py-2.5 flex items-center justify-center uppercase rounded-lg transition"
              >
              ...
              <div className="w-full space-y-0.5">
                <button
                  disabled
                  className="w-full bg-red-500 hover:bg-primary/90 text-sm text-neutral-50 font-normal py-2.5 flex items-center justify-center uppercase rounded-lg transition cursor-not-allowed"
                >
                  Processed to Checkout
                </button>
